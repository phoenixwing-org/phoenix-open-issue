...
- **当前包版本 `0.7.1`**：Open Issue 已收敛为 Phoenix Admin 声明式业务插件，使用 `.phoenix.cool` 不可变制品；本补丁版本修复 PostgreSQL 示例数据 8D 标识符，并补齐 Windows 首次启动与 Junction 挂载说明，详见 [CHANGELOG](CHANGELOG.md)。
