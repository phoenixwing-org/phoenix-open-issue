...
router.get('/auth/login-policy', wrap((req, res) => externalAuthCtrl.getLoginPolicy(req, res)))
router.put('/admin/login-policy', authMiddleware, wrap((req, res) => externalAuthCtrl.updateLoginPolicy(req, res)))
...
router.get('/auth/oauth/bind-request', oauthTicketLimit, wrap((req, res) => externalAuthCtrl.getBindRequestProfile(req, res)))
router.post('/auth/oauth/bind-request/profile', oauthTicketLimit, wrap((req, res) => externalAuthCtrl.updateBindRequestProfile(req, res)))
...
router.get('/users/username-available', authMiddleware, wrap((req, res) => externalAuthCtrl.usernameAvailable(req, res)))
router.get('/admin/external-bind-requests', authMiddleware, wrap((req, res) => externalAuthCtrl.listBindRequests(req, res)))
router.patch('/admin/external-bind-request/:requestId', authMiddleware, wrap((req, res) => externalAuthCtrl.updateBindRequest(req, res)))
router.post('/admin/external-bind-request/:requestId/bind', authMiddleware, wrap((req, res) => externalAuthCtrl.bindRequest(req, res)))
router.post('/admin/external-bind-request/:requestId/create-and-bind', authMiddleware, wrap((req, res) => externalAuthCtrl.createAndBindRequest(req, res)))
router.post('/admin/external-bind-request/:requestId/reject', authMiddleware, wrap((req, res) => externalAuthCtrl.rejectBindRequest(req, res)))
