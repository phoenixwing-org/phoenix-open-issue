...
import { getMyPushHistory, getPushTargetLists, handlePush, withdrawPush } from '@/api/push'
...
import type { PushRecord, PushTargetListOption } from '@open-issue/core'
...
function goList(listId: string | null) {
  if (listId) router.push(`/list/${listId}`)
}
