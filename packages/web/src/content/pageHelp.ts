...
export const PAGE_HELP: Record<string, PageHelpContent> = {
  ...
  listDetail: {
    ...
    bullets: [
      ...
      "筛选栏：文本搜索、状态、严重度、分类；勾选「显示已作废」。",
      "列头排序 + 列宽拖拽；点击行进入 Issue 详情。",
      "状态下拉：切换状态、📄 作废、🔄 恢复、🗑 删除（暂禁）。",
      "「成员」管理列表成员与角色权限。",
  ...
  org: {
    ...
    bullets: [
      "树形展示组织层级（部 → 科室 → 小组）。",
      "点击节点查看该组织下的成员列表。",
      "新建/编辑/删除组织节点；将用户分配到具体组织。",
      "审批新注册用户（从待定组批准）。",
      "禁用/启用用户：禁用后无法登录，已分配处仍显示姓名。",
    ],
  },
  pushHistory: {
    title: "推送历史",
