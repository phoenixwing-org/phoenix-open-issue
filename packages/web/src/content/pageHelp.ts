...
export const PAGE_HELP: Record<string, PageHelpContent> = {
  ...
  dashboard: {
    ...
    bullets: [
      ...
      "点击卡片进入列表详情；📦 按钮确认后归档列表，归档视图中可取消归档。",
    ...
    tourSteps: [
      ...
      step("[data-tour='dashboard-cards']", "列表卡片", "点击卡片进入 Issue 管理页。📦 图标确认后归档列表，归档视图中可取消归档。"),
    ],
  },
  lists: {
    title: "列表管理",
    ...
    tourSteps: [
      ...
      step("[data-tour='lists-table']", "列表总览", "状态列区分正常、已归档、已删除。操作栏可编辑、归档/取消归档、删除或恢复列表。"),
    ],
  },
  listDetail: {
    title: "列表详情",
