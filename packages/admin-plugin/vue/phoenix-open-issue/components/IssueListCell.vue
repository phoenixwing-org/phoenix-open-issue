...
import type { IssueColumnKey } from '/$/phoenix-open-issue/config/issueListColumns'
import type { Checkpoint } from '/$/phoenix-open-issue/core'
import { ATTENTION_LEVEL_LABELS, isOverdue } from '/$/phoenix-open-issue/core'
...
const ctx = inject<{
  ...
  severityTag: Record<string, TagType | undefined>
  priorityLabel: Record<string, string>
  priorityTag: Record<string, TagType | undefined>
  statusLabel: Record<string, string>
  statusTag: Record<string, TagType | undefined>
