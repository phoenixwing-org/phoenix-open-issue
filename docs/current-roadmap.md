...
- 生产包与开发门禁精确要求 Registry `phoenix-wing@0.7.0`，不把相邻源码或 Wing 本地构建收入制品；singleton、Ribbon/Tree 工作台、View contribution、依赖来源和自动测试继续由门禁验证。根包未变更的 scoped 依赖按发布矩阵保持 `0.6.3`。
